...
CREATE TABLE IF NOT EXISTS `mydb`.`ADVERTISEMENT` (
  ...
  `deleted` BIT(1) NULL,
  PRIMARY KEY (`id`, `person_id`, `property_id`),
  INDEX `fk_ADVERTISEMENT_USER1_idx` (`person_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`FAVORITE_ADS` (
  ...
  INDEX `fk_USER_has_ADVERTISEMENT_USER1_idx` (`person_id` ASC) VISIBLE,
